...
\usepackage{jurabib}			% Paket für das Literaturverzeichnis
...
\newcommand{\studiengang}{Angewandte Informatik -- International Business Competence}
\newcommand{\autor}{Stephan Giesau, Sebastian Kowalski, Raffael Wojtas}
\newcommand{\autorshort}{S. Giesau, S. Kowalski, R. Wojtas}
\newcommand{\matrikelnr}{5890600, 6664480, 7998056}
\newcommand{\kurs}{TINF12AI-BC}
\newcommand{\firma}{}
\newcommand{\zeitraum}{15.09.2014 - 01.06.2015}
\newcommand{\betreuerdhbw}{Prof. Dr. Christian Bürgy}
\newcommand{\betreuerfirma}{}
\newcommand{\location}{Mannheim}
...
\lhead{}								% Kopf links
\chead{}								% Kopf mitte
\rhead{\rmfamily{\titelzwei}}				% Kopf rechts
\lfoot{}								% Fuß links
\cfoot{\rmfamily{\thepage}}				% Fuß mitte
\rfoot{\rmfamily{\autorshort}}				% Fuß rechts
...
% \include{Inhalt/formular_aufgabenstellung}	% Einbinden des Formulars der Aufgabenstellung

\tableofcontents							% Erzeugen des Inhalsverzeichnisses
%\printnomenclature[2.0cm]					% Erzeugen des Abkürzungsverzeichnisses
\newpage
\input{Inhalt/acronym}
...
\include{Inhalt/Kapitel/vorwort}
\include{Inhalt/Kapitel/bedarfsanalyse}
\include{Inhalt/Kapitel/technik}
\include{Inhalt/Kapitel/anforderungsanalyse}
\include{Inhalt/Kapitel/architektur}
\include{Inhalt/Kapitel/implementierung_web}
\include{Inhalt/Kapitel/implementierung_rest}
\include{Inhalt/Kapitel/implementierung_device}
\include{Inhalt/Kapitel/zusammenfassung}	
